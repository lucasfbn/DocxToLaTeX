...
setup(
  ...
  packages = ['docx_to_latex'],   # Chose the same as "name"
  version = '0.2.4.1',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/lucasfbn/DocxToLaTeX/archive/v_0.2.4.1.tar.gz',    # I explain this later on
