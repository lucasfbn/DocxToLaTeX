...
setup(
    ...
    version='0.3.0.2',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/lucasfbn/DocxToLaTeX/archive/v_0.3.0.2.tar.gz',  # I explain this later on
